...
# preparando espaço para 7 vértices usando 2 coordenadas (x,y)
...
# ##  Novidade aqui: pegamos a localização da variável color (uniform) para que possamos alterá-la em nosso laço da janela.
